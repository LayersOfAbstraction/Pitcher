...
namespace Pitcher.Models
{
    public class Job
    {
        ...
        [Required]
        [StringLength(18, ErrorMessage = "Username Cannot be longer than 18 characters.")]
        [Display(Name = "Username")]
        [Column("UserLogInName")]
        public string UserLogInName { get; set; }

        [Required]
        [StringLength(18, MinimumLength = 8, ErrorMessage = "Password Cannot be longer than 18 characters.")]
